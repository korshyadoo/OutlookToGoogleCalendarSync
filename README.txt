...
the java-libpst library, which can be found at the respective 
websites:
...
removed from the ArrayList. If a .pst appointment is not in the 
query ArrayList, it is added to a second, insert queue, 
...
Also, the password text box always shows the password being 
typed; a proper password box will be implemented in the future. 
